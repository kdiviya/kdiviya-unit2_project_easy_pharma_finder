...
import { faHouse, faUser,faMortarPestle, faLock, faRightFromBracket, faBars, faUserGroup, faPills, faPrescriptionBottle, faUsers, faComment} from '@fortawesome/free-solid-svg-icons';
